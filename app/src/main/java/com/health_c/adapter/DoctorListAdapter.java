...
import com.health_c.activity.DoctorInfoActivity;
...
/**
 * Created by Admin on 2016/8/1. 医生信息列表适配器 DoctorInfoActivity使用
 */
public class DoctorListAdapter extends BaseAdapter {
    DoctorInfoActivity mContext;
    private LayoutInflater inflater;
    private ArrayList<ArrayList<String>> lists;
    HashMap<String, Boolean> checkState = new HashMap<>();

    public DoctorListAdapter(DoctorInfoActivity mContext, LayoutInflater inflater, ArrayList<ArrayList<String>> lists) {
        super();
